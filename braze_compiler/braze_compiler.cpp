...
int main(int argc, char* argv[]) {
  ...
  else if (argc < 4)
  {
    ...
    {
      std::cout << "\ncall braze with --input_file <file_to_compile> to compile the file";
      std::cout << "\n<file_to_compile>.asm will be generated with assembly code ";
      std::cout << "\n<file_to_compile>.o will be generated by nasm, which is invoked asmake assembler ";
      std::cout << "\nan executable named <file_to_compile> (no suffix) will be created ";
