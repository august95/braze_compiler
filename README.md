Braze compiler - for 32 bit x86 architecture. Compiles a subset of C. See feature list:
...
Known limitations:
1. No pre processor support, include dosn't work. In order to use Printf, declare the following prototype at the top of the file, and let nasm link it: "int printf(const char *format, ...);" 
...
To see examples of implemented language features, see: /unit_test/test_files/codegeneration/
